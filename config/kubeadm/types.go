...
type ClusterConfiguration struct {
	...
	// EncryptionAlgorithm holds the type of asymmetric encryption algorithm used
	// for keys and certificates.
	// Can be one of "RSA-2048" (default), "RSA-3072", "RSA-4096", "ECDSA-P256" or "ECDSA-P384".
	EncryptionAlgorithm EncryptionAlgorithmType

	// CertificateValidityPeriod specifies the validity period for a non-GA certificate
...
type JoinConfiguration struct {
	...
	// DryRun tells if the dry run mode is enabled, don't apply any change if it is enabled,
