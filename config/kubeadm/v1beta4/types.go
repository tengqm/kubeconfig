...
type DNS struct {
	...
	// Diabled specifies whether to disable this addon in the cluster.
	Disabled bool `json:"disabled,omitempty"`
}

// Proxy defines the proxy addon that should be used in the cluster.
type Proxy struct {
	// Disbled specifies whether to disable this addon in the cluster.
	Diabled bool `json:"disabled,omitempty"`
}
